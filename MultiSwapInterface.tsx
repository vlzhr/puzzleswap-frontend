...
export class MultiSwapInterface extends React.Component<IProps, IState>{
    ...
    handleMaxClick() {
        this.setState({
            amountIn: this.getTokenInBalance(),
            amountInStr: this.getTokenInBalance().toString()
        })
    }
                ...
                <div className="swap-window">
                    ...
                    <div>
                        <div className="comp">
                            ...
                            <div>
                                <input onChange={(e) => this.handleInput(e)} type="text" value={this.state.amountInStr} placeholder="0"/>
                        ...
                        <ModalWindow poolData={this.poolData} tokenOut={this.state.tokenOut}
                                     toReceive={(this.poolData.contractAddress === "3PFDgzu1UtswAkCMxqqQjbTeHaX4cMab8Kh" || this.poolData.contractAddress === "3PNK5ypnPJioLmLUzfK6ezpaePHLxZd6QLj") ? 0 : Math.floor(this.calculateAmountOut(0.95) * this.poolData.tokenDecimals[this.state.tokenOut]) / this.poolData.tokenDecimals[this.state.tokenOut]}
                                     txData={{
                                         pmt: {
