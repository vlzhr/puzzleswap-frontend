            ...
            <div className="landing__invest">
                <div className="landing__invest--lc">
                    ...
                    <p className="landing__desc">
                        ...
                        <br/>
                        <a href="https://collective.wavesducks.com" target="_blank"><strong>Learn more on our Medium</strong></a>.
                    </p>
                    <Link to="/defi"><button className="button primary large">Invest</button></Link>
                </div>
